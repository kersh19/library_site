...
(function ($) {
    ...
    special = {
        Reset: function () {
            ...
            $("head").append($('<link rel="stylesheet" type="text/css" />').attr("href", "/eyeless/special.css"));
...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
    ...
    a.speak = function (b, c, e) {
        if (a.iOS9 && !a.iOS9_initialized) a.log("Initializing ios9"), setTimeout(function () {
            ...
            } else a.log("Using SpeechSynthesis"), d = new SpeechSynthesisUtterance, d.voiceURI = f.systemvoice.voiceURI, d.volume = a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1]), d.rate = a.selectBest([a.iOS9 ? 1 : null, f.collectionvoice.rate, f.systemvoice.rate, 1]), d.pitch = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1]), d.text = h[g], d.lang = a.selectBest([f.collectionvoice.lang, f.systemvoice.lang]), d.rvIndex = g, d.rvTotal = h.length, 0 == g && (d.onstart = a.speech_onstart), a.msgparameters.onendcalled = !1, null != e ? (d.voice = "undefined" !== typeof e.voice ? e.voice : f.systemvoice, g < h.length - 1 && 1 < h.length ? (d.onend = a.onPartEnd, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.onPartEnd)) : (d.onend = a.speech_onend, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.speech_onend)), d.onerror = e.onerror || function (b) {
