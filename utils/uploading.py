...
class ImageUploadHelper:
    ...
    @classmethod
    def get_field_to_combine_add_upload_postfix(cls,klass):
...
def upload_function(instance,filename):
    ...
    field_to_combine, upload_postfix = ImageUploadHelper.get_field_to_combine_add_upload_postfix(instance.__class__.__name__)
